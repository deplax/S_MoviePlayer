...
public class MoviePlayer {
	...
	public MoviePlayer(File file, String fileName, Controller con) {
		...
		final DoubleProperty borderPaneW = borderPane.prefWidthProperty();
		borderPaneW.bind(Bindings.selectDouble(view.sceneProperty(), "width"));
		
		final DoubleProperty borderPaneH = borderPane.prefHeightProperty();
		borderPaneH.bind(Bindings.selectDouble(view.sceneProperty(), "height"));
